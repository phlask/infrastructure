    ...
    "Statement": [
        {
            ...
            "Principal": "*",
            "Action": "s3:GetObject",
            "Resource": "arn:aws:s3:::test.phlask.me/*",
            "Condition":{
                "StringLike":{"aws:Referer":["https://test.phlask.me/*"]}
            }
        }
    ]
}
    ...
    "Statement": [
        {
            ...
            "Action": "s3:GetObject",
            "Resource": "arn:aws:s3:::phlask-tap-images/*"
        }
    ]
}
  POLICY
...
resource "aws_s3_bucket_public_access_block" "test_site" {
  provider = aws.us-east-2
